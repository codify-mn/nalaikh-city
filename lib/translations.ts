...
export const translations = {
  mn: {
    ...
    fundingSourcesDesc: "Олон улсын сан, гадаад, дотоодын хөрөнгө",

    // Implementation Timeline
    implementationTimeline: "Хэрэгжилтийн хугацаа",
    ...
    phase1: "1-р үе шат: Төлөвлөлт",
    phase2: "2-р үе шат: Хэрэгжилт",
  ...
  en: {
    ...
    fundingSourcesDesc: "International funds, foreign and domestic investment",
  ...
  zh: {
    ...
    urbanDevelopmentDesc: "现代住房与基础设施",
    economicZone: "经济特区",
    economicZoneDesc: "投资与营商环境",
    greenNalaikhProject: "绿色纳来哈",
    greenNalaikhDesc: "环保、可持续发展",

    // Benefits
    benefitsTitle: "这些项目带来的益处",
    benefitsDesc: "对纳来哈市经济与社会发展的影响",
    greenFinancing: "吸引绿色融资",
    greenFinancingDesc: "有机会从国际绿色基金吸引资金",
    exportSupport: "出口支持改善",
    exportSupportDesc: "提高制造产品的出口",
    jobCreation: "劳动力需求增加",
    jobCreationDesc: "新的就业机会与职业发展",
    newTechnology: "引入新技术",
    newTechnologyDesc: "创新与数字化转型",

    // Statistics
    projectCoordination: "项目协调",
    projectCoordinationDesc: "确保项目间协调",
    livingEnvironment: "宜居环境",
    livingEnvironmentDesc: "改善城市形象",
    developmentModel: "发展模型",
    developmentModelDesc: "建立示范模型",

    // Housing Statistics
    housingStats: "住房统计",
    housingShortage: "住房短缺",
    downPaymentCapable: "具备首付能力",
    downPaymentCapableDesc: "有社保、工资收入、首付与抵押资产",
    noDownPayment: "无首付款储蓄",
    noDownPaymentDesc: "虽有社保和工资收入证明，但缺乏首付款",
    mortgageDemand: "户 - 按揭贷款需求",
    totalBorrowers: "总借款人：",
    normalLoans: "正常贷款：",
    badLoans: "不良贷款：",
    totalRisk: "总风险金额",
    ...
    financingSolutionsDesc: "无复利、成本节约的公司融资",
    constructionFinancing: "建设融资与公司融资",
    currentProblem: "当前问题：",
    currentProblemDesc:
      "建设项目实施单位通常通过从银行和金融机构获取商业贷款来解决建设期间所需的资金。商业贷款年利率为 23%。",
    solution: "解决方案：",
    solutionDesc:
      "如果我们从建设开始就将市民纳入按揭贷款，这一利息问题将得到解决。",
    ...
    // Four Solutions
    downPaymentInsurance: "首付款保险",
    downPaymentInsuranceDesc: "针对青年友好的住房计划，包含保险与担保机制",
    corporateFinancing: "公司融资",
    corporateFinancingDesc: "无复利、成本节约",
    fundingSources: "资金来源",
    fundingSourcesDesc: "国际基金、国内外投资",
    ...
    careers: "职位",
    news: "新闻",
    copyright: "© 2025 纳来哈市发展公司有限责任公司。版权所有。",
    waterFeatures: "水景设施",
    waterFeaturesDesc: "池塘、水库、水上乐园及其他水元素",
